...
object ProviderConfigs {
    ...
    val OPENAI = ProviderConfig(
        ...
        supportsVision = true,
        models = listOf("gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol", "gpt-chat-latest", "gpt-4o-mini"),
    ...
    val VENICE = ProviderConfig(
        ...
        models = listOf("venice-uncensored-1-2", "qwen3-6-27b", "zai-org-glm-4.7", "deepseek-v4-flash", "google-gemma-4-31b-it", "llama-3.3-70b"),
    ...
    val OPENROUTER = ProviderConfig(
        ...
        supportsVision = true,
        models = listOf("auto", "openrouter/auto"),
        defaultModel = "auto",
    ...
    val ANTHROPIC = ProviderConfig(
        ...
        supportsVision = true,
        models = listOf("claude-sonnet-5", "claude-opus-5", "claude-haiku-4-5-20251001", "claude-fable-5"),
    ...
    val GEMINI = ProviderConfig(
        ...
        supportsVision = true,
        models = listOf("gemini-3.7-flash", "gemini-3.6-flash", "gemini-3.5-flash-lite", "gemini-2.5-flash", "gemini-3.1-pro-preview"),
